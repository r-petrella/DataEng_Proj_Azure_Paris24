...
6. we create 4 containers in Azure storage account:
    ...
    - bronze: no transformation but conversion of all .csv to .parquet to save resources.
    ...
    - gold: dimensional layer complaying with the kimball model.
            - identification of the business processes related to data
            - identifications of dimensions and facts
            - creation of the star schema layout to connect to the reporting system
